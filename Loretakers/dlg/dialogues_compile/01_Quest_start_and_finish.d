...
==%IMOEN_JOINED% IF ~InParty("%IMOEN_DV%") !StateCheck("%IMOEN_DV%",CD_STATE_NOTVALID)~ THEN @13
...
==XANJ IF ~InParty("XAN") !StateCheck("XAN",CD_STATE_NOTVALID)~ THEN @17
==%NEERA_JOINED% IF ~InParty("NEERA") !StateCheck("NEERA",CD_STATE_NOTVALID)~ THEN @18
==BAELOTHJ IF ~InParty("BAELOTH") !StateCheck("BAELOTH",CD_STATE_NOTVALID)~ THEN @19
==%EDWIN_JOINED% IF ~InParty("EDWIN") !StateCheck("EDWIN",CD_STATE_NOTVALID)~ THEN @20
==AC#FPST1 @21
END
...
==AC#FPST2@33
==AC#FPST1 @34
==%MINSC_JOINED% IF ~InParty("MINSC") !StateCheck("MINSC",CD_STATE_NOTVALID)~ THEN @35
==AC#FPST2 @36
...
@84
==%EDWIN_JOINED% IF ~InParty("EDWIN") !StateCheck("EDWIN",CD_STATE_NOTVALID)~ THEN @85
...
@91
==%DORN_JOINED% IF ~InParty("DORN") !StateCheck("DORN",CD_STATE_NOTVALID)~ THEN @92
==AC#FPST2 @93
END
